...
<div id="container">
  <h2>No route matches [GET] &quot;/posts/vendor/bootstrap/js/bootstrap.bundle.min.js&quot;</h2>

  
<p><code>Rails.root: /Users/matthewblack/Desktop/wip-it/new_wip/wip-it</code></p>
...
<div id="traces">
    ...
    <div id="Framework-Trace" style="display: none;">
      <pre><code><a class="trace-frames" data-frame-id="0" href="#">actionpack (5.1.5) lib/action_dispatch/middleware/debug_exceptions.rb:63:in `call&#39;</a><br><a class="trace-frames" data-frame-id="1" href="#">web-console (3.5.1) lib/web_console/middleware.rb:135:in `call_app&#39;</a><br><a class="trace-frames" data-frame-id="2" href="#">web-console (3.5.1) lib/web_console/middleware.rb:28:in `block in call&#39;</a><br><a class="trace-frames" data-frame-id="3" href="#">web-console (3.5.1) lib/web_console/middleware.rb:18:in `catch&#39;</a><br><a class="trace-frames" data-frame-id="4" href="#">web-console (3.5.1) lib/web_console/middleware.rb:18:in `call&#39;</a><br><a class="trace-frames" data-frame-id="5" href="#">actionpack (5.1.5) lib/action_dispatch/middleware/show_exceptions.rb:31:in `call&#39;</a><br><a class="trace-frames" data-frame-id="6" href="#">railties (5.1.5) lib/rails/rack/logger.rb:36:in `call_app&#39;</a><br><a class="trace-frames" data-frame-id="7" href="#">railties (5.1.5) lib/rails/rack/logger.rb:24:in `block in call&#39;</a><br><a class="trace-frames" data-frame-id="8" href="#">activesupport (5.1.5) lib/active_support/tagged_logging.rb:69:in `block in tagged&#39;</a><br><a class="trace-frames" data-frame-id="9" href="#">activesupport (5.1.5) lib/active_support/tagged_logging.rb:26:in `tagged&#39;</a><br><a class="trace-frames" data-frame-id="10" href="#">activesupport (5.1.5) lib/active_support/tagged_logging.rb:69:in `tagged&#39;</a><br><a class="trace-frames" data-frame-id="11" href="#">railties (5.1.5) lib/rails/rack/logger.rb:24:in `call&#39;</a><br><a class="trace-frames" data-frame-id="12" href="#">sprockets-rails (3.2.1) lib/sprockets/rails/quiet_assets.rb:13:in `call&#39;</a><br><a class="trace-frames" data-frame-id="13" href="#">actionpack (5.1.5) lib/action_dispatch/middleware/remote_ip.rb:79:in `call&#39;</a><br><a class="trace-frames" data-frame-id="14" href="#">actionpack (5.1.5) lib/action_dispatch/middleware/request_id.rb:25:in `call&#39;</a><br><a class="trace-frames" data-frame-id="15" href="#">rack (2.0.4) lib/rack/method_override.rb:22:in `call&#39;</a><br><a class="trace-frames" data-frame-id="16" href="#">rack (2.0.4) lib/rack/runtime.rb:22:in `call&#39;</a><br><a class="trace-frames" data-frame-id="17" href="#">activesupport (5.1.5) lib/active_support/cache/strategy/local_cache_middleware.rb:27:in `call&#39;</a><br><a class="trace-frames" data-frame-id="18" href="#">actionpack (5.1.5) lib/action_dispatch/middleware/executor.rb:12:in `call&#39;</a><br><a class="trace-frames" data-frame-id="19" href="#">actionpack (5.1.5) lib/action_dispatch/middleware/static.rb:125:in `call&#39;</a><br><a class="trace-frames" data-frame-id="20" href="#">rack (2.0.4) lib/rack/sendfile.rb:111:in `call&#39;</a><br><a class="trace-frames" data-frame-id="21" href="#">railties (5.1.5) lib/rails/engine.rb:522:in `call&#39;</a><br><a class="trace-frames" data-frame-id="22" href="#">puma (3.11.2) lib/puma/configuration.rb:225:in `call&#39;</a><br><a class="trace-frames" data-frame-id="23" href="#">puma (3.11.2) lib/puma/server.rb:624:in `handle_request&#39;</a><br><a class="trace-frames" data-frame-id="24" href="#">puma (3.11.2) lib/puma/server.rb:438:in `process_client&#39;</a><br><a class="trace-frames" data-frame-id="25" href="#">puma (3.11.2) lib/puma/server.rb:302:in `block in run&#39;</a><br><a class="trace-frames" data-frame-id="26" href="#">puma (3.11.2) lib/puma/thread_pool.rb:120:in `block in spawn_thread&#39;</a><br></code></pre>
    </div>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='user_comments'>
      user_comments<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/comments(.:format)'>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_user_comment'>
      new_user_comment<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/comments/new(.:format)'>
    /users/:user_id/comments/new(.:format)
  </td>
  <td>
    <p>comments#new</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_user_comment'>
      edit_user_comment<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/comments/:id/edit(.:format)'>
    /users/:user_id/comments/:id/edit(.:format)
  </td>
  <td>
    <p>comments#edit</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='user_comment'>
      user_comment<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/comments/:id(.:format)'>
...
<tr class='route_row' data-helper='path'>
  ...
  <td>
    <p>comments#destroy</p>
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='user_recipes'>
      user_recipes<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/recipes(.:format)'>
    /users/:user_id/recipes(.:format)
  </td>
  <td>
    <p>recipes#index</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_user_recipe'>
      new_user_recipe<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/recipes/new(.:format)'>
    /users/:user_id/recipes/new(.:format)
  </td>
  <td>
    <p>recipes#new</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_user_recipe'>
      edit_user_recipe<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/recipes/:id/edit(.:format)'>
    /users/:user_id/recipes/:id/edit(.:format)
  </td>
  <td>
    <p>recipes#edit</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='user_recipe'>
      user_recipe<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/recipes/:id(.:format)'>
    /users/:user_id/recipes/:id(.:format)
  </td>
  <td>
    <p>recipes#show</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='user_posts'>
      user_posts<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/posts(.:format)'>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_user_post'>
      new_user_post<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/posts/new(.:format)'>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_user_post'>
      edit_user_post<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/posts/:id/edit(.:format)'>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='user_post'>
      user_post<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/users/:user_id/posts/:id(.:format)'>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/comments(.:format)'>
    /comments(.:format)
  </td>
  <td>
    <p>comments#index</p>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/comments/new(.:format)'>
    /comments/new(.:format)
  </td>
  <td>
    <p>comments#new</p>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/comments/:id/edit(.:format)'>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/comments/:id(.:format)'>
    /comments/:id(.:format)
  </td>
  <td>
    <p>comments#show</p>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='friendsips'>
      friendsips<span class='helper'>_path</span>
  </td>
  <td>
    POST
  </td>
  <td data-route-path='/friendsips(.:format)'>
    /friendsips(.:format)
  </td>
  <td>
    <p>friendsips#create</p>
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_friendsip'>
      new_friendsip<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/friendsips/new(.:format)'>
    /friendsips/new(.:format)
  </td>
  <td>
    <p>friendsips#new</p>
  </td>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='friendsip'>
      friendsip<span class='helper'>_path</span>
  </td>
  <td>
    DELETE
  </td>
  <td data-route-path='/friendsips/:id(.:format)'>
    /friendsips/:id(.:format)
  </td>
  <td>
    <p>friendsips#destroy</p>
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/likes(.:format)'>
    /likes(.:format)
  </td>
  <td>
    <p>likes#create</p>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/likes/new(.:format)'>
    /likes/new(.:format)
  </td>
  <td>
    <p>likes#new</p>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/likes/:id(.:format)'>
    /likes/:id(.:format)
  </td>
  <td>
    <p>likes#destroy</p>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='notifications'>
      notifications<span class='helper'>_path</span>
  </td>
  <td>
    POST
  </td>
  <td data-route-path='/notifications(.:format)'>
    /notifications(.:format)
  </td>
  <td>
    <p>notifications#create</p>
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_notification'>
      new_notification<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/notifications/new(.:format)'>
    /notifications/new(.:format)
  </td>
  <td>
    <p>notifications#new</p>
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='notification'>
      notification<span class='helper'>_path</span>
  </td>
  <td>
    DELETE
  </td>
  <td data-route-path='/notifications/:id(.:format)'>
    /notifications/:id(.:format)
  </td>
  <td>
    <p>notifications#destroy</p>
  </td>
</tr>
<tr class='route_row' data-helper='path'>
  <td data-route-name='recipes'>
      recipes<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/recipes(.:format)'>
    /recipes(.:format)
  </td>
  <td>
    <p>recipes#index</p>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='new_recipe'>
      new_recipe<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/recipes/new(.:format)'>
    /recipes/new(.:format)
  </td>
  <td>
    <p>recipes#new</p>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='edit_recipe'>
      edit_recipe<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/recipes/:id/edit(.:format)'>
...
<tr class='route_row' data-helper='path'>
  <td data-route-name='recipe'>
      recipe<span class='helper'>_path</span>
  </td>
  <td>
    GET
  </td>
  <td data-route-path='/recipes/:id(.:format)'>
    /recipes/:id(.:format)
  </td>
  <td>
    <p>recipes#show</p>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/sessions/new(.:format)'>
    /sessions/new(.:format)
  </td>
  <td>
    <p>sessions#new</p>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/sessions/:id(.:format)'>
    /sessions/:id(.:format)
  </td>
  <td>
...
<tr class='route_row' data-helper='path'>
  ...
  <td data-route-path='/search(.:format)'>
    /search(.:format)
  </td>
  <td>
    <p>search#index</p>
...
<div class="details">
  ...
  <div id="session_dump" style="display:none"><pre>_csrf_token: &quot;QTTPUCXNYzFMURsrht5Ek4qCQ1AyrIVZ9X52sk3ePTI=&quot;
session_id: &quot;e6a7b95c7ae24dec0da75bbdbebba013&quot;
user_id: 1</pre></div>
</div>
...
<div id="console"
  ...
  data-session-id='1b3c33f4c40cff2a9030cce34a4bd5f8'
  data-prompt-label='>> '>
</div>
